...
public class StringEx_01 {
	...
	public static void main(String[] args) {
		...
		String menu = null;
		if (menu == null) {
			System.out.println("menu에 저장된 값은 null");
		...
		/*
		 * switch 명령은 다중 if else, else if를 대신하여 사용할 수 있는 구조적인 명령문이다
		 * 단점이 반드시 case 조건을 수행한다음 break;를 실행하여
		 ...
		 * 
		 * switch는 변수가 숫자형 일 경우에만 사용하는 것이 오류를 막고 깔끔한 코드가 될 수 있다.
		 */
		if (menu != null) {
			switch (menu) {
			case "1":

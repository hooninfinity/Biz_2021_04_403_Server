...
<script>
// DOM(Document Object Model) : html로 작성된 문서와 요소(tag)에 객체지향저인 개념으로 접근하여
// 								css, js등을 쉽게 적용할 수 있도록 함
...
<style>
	...
	/* form tag는 block tag type 이기 때문에 button tag와 한 라인에 배치하기 위하여
		display type을 inline-block으로 변환하고 width를 제한하여 설정하였다 */
	section#main form {

...
/*
 * DB 연동하는 프로젝트에는 필수적으로 구현해야할 method가 있다
...
public interface BookService {
	...
	// 도서정보 데이터를 1개 전달받아서 DB에 insert를 수행
	// 도서정보 데이터는 ISBN, 도서명, 출판사코드, 저자코드, 발행일, 가격, 페이지 의 데이터가 포함된다
	...
	// 	도서정보 1개를 return하는 기능을 수행할 method
	// PK 1개를 전달받아 조회하는 method는
	//	0 또는 1개의 데이터만 return한다
